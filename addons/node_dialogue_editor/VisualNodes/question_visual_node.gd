@tool
## Visual representation of a QuestionNode inside the GraphEdit.
## Provides fields to edit the speaker, dialogue text, and handles resizing.
class_name QuestionVisualNode
extends GraphNode

## The QuestionNode resource this visual node is bound to.
var resource: QuestionNode
...
## Assigns the QuestionNode resource and populates the UI with its values.
func set_resource(res: QuestionNode) -> void:
	resource = res
